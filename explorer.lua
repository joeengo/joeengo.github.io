--[[ 
  ...
  Copy this loadfile for full file load (fastest) - note: run internet loadstring before using files for now
  loadfile('explorer-v3/init.lua')()

  engo explorer is still a work in progress - this is a beta release
]]
